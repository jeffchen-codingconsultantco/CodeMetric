...
{
    public class HalsteadAnalyzer : CSharpSyntaxWalker
    {
		...
		/// This method may be overridden if subclasses want to handle the node.
		/// Overrides should call back into this base method if they want the children of this node to be visited.
		/// </summary>
